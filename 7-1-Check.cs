/*
Описать структуру Check. Предусмотреть функцию добавления информации о товаре 
(наименование, количество, цена за единицу товара, скидка) в чек, функцию 
распечатки чека на экране консоли.
 */
...
namespace _7_1_Check
{
    ...
    struct Check
    {
        ...
        public void Print()
        {
            ...
            Console.WriteLine("{0,37}","ООО \"Пупкин\"            ");
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            check.AddProduct("Конфета", 3, 3.56, Discount.Incentive);
            check.AddProduct("Мороженое", 2, 8.56, Discount.Patron);
            check.AddProduct("Шоколад", 5, 19.5, Discount.Default);
            check.Print();
        }
    }
}